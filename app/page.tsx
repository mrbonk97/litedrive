      ...
      <main className="">
        ...
        <section className="mt-20 bg-secondary">
          <div className="p-4 py-14 sm:py-28 mx-auto max-w-6xl">
            ...
            <h5 className="mt-2 sm:mt-4 font-medium opacity-70">
              파일 관리에 필요한 핵심 기능을 확인해보세요
            </h5>
            <div>
              <p className="mt-20 text-lg sm:text-3xl font-bold opacity-80">
                대시보드
              </p>
              <Image
            ...
            <div className="mt-40">
              <p className="text-lg sm:text-3xl font-bold opacity-80">
                파일공유 및 다운로드
              </p>
              <Image
          ...
          <ol className="mt-20 space-y-16">
            <li className="p-4 bg-secondary rounded text-4xl font-bold">
              ...
              <p className="mt-8 text-sm sm:text-lg font-semibold break-keep">
                보안 전문가가 직접 설계하고 취약점 검사를 수행한 시스템입니다.
                LiteDrive는 안전한 전송을 최우선으로 생각합니다.
              </p>
            </li>
            ...
            <li className="p-4 bg-secondary rounded text-4xl font-bold">
              ...
              <p className="mt-8 text-sm sm:text-lg font-semibold break-keep">
                ...
                모든 데이터는 즉시 완전 삭제되어,
                <span className="text-rose-400">복구가 불가능하도록 설계</span>
                되었습니다.
              </p>
            </li>
            ...
            <li className="p-4 bg-secondary rounded text-4xl font-bold">
              ...
              <p className="mt-8 text-sm sm:text-lg font-semibold break-keep">
                단순히 파일만 빠르게 주고받고 싶은데, 매번 2차 인증이
                번거로우셨나요? 공용 PC에서 개인 계정 로그인이 불안하셨다면,
                LiteDrive는 가볍게 회원가입 후 바로 사용할 수 있습니다.
              </p>
            </li>
          </ol>
        </section>
